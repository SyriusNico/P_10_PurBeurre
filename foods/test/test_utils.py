...
class TestUtils(TestCase):
	...
	def test_product_is_notated_by_many_user(self, product="nutella", mark=5):
	...
	def test_user_can_notate(self):
		# toto = User.objects.get(username="Toto")
		# if self.assertIsInstance(toto, User):
		pass